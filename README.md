...
| getLinksOnTheCurrentSite  | void / std::vector | *ЕЩЕ НЕ РЕАЛИЗОВАН!!!* Возвращает вектор ссылок найденных на текущем сайте, *Возможно тут необходимо сделать запрос с помощтб метода [Database](#База-данных) для проверки уже существующих ссылок*|
...
_Пытался реализовать запросы к БД с помощью параметризованных запросов, но было много ошибок остановился на примитивной реализации_

_Где лучше правельнее реализовать запрет на запись слов, если данный сайт уже просматривался??_